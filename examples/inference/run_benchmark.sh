...
for bsz in 4; do
    CUDA_LAUNCH_BLOCKING=1 compute-sanitizer --tool memcheck python3 ${PY_SCRIPT} -m llama2-7b --tp_size 1 --pp_size 1 -b $bsz -s 32 --output_len 16 --mode ${mode} | tee logs/${mode}_${GPU}_${bsz}_256.txt
done
