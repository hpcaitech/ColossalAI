...
def run_llama_test(args):
    ...
    infer_args = {"inference_only": True, "inference_gptq": True}
    shard_config = ShardConfig(enable_tensor_parallelism=True if args.tp_size > 1 else False, extra_kwargs=infer_args)
