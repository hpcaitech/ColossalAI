...
locust -f locustfile.py -t 300 --tags online-generation --host http://127.0.0.1:8001 --autostart --users 300 --stop-timeout 10
echo "Test chat api"
locust -f locustfile.py -t 300 --tags online-chat --host http://127.0.0.1:8001 --autostart --users 300 --stop-timeout 10
# kill Server
