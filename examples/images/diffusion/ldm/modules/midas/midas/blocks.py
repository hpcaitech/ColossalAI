...
from .vit import _make_pretrained_vitb16_384, _make_pretrained_vitb_rn50_384, _make_pretrained_vitl16_384, forward_vit
...
def _make_encoder(
    ...
    if backbone == "vitl16_384":
        ...
        scratch = _make_scratch([256, 512, 1024, 1024], features, groups=groups,
        ...
        scratch = _make_scratch([256, 512, 768, 768], features, groups=groups,
        ...
        scratch = _make_scratch([96, 192, 384, 768], features, groups=groups,
