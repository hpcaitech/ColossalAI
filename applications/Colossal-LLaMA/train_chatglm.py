...
# -*- coding: utf-8 -*-
"""
Continual Pre-training/Supervised fine-tuning of chatglm2-6b developed by Colossal-AI Team
"""
...
def train(args) -> None:
    ...
    if args.plugin == "ddp":
        ...
        plugin = GeminiPlugin(
            ...
            enable_fused_normalization=torch_npu.npu.is_available(),
    ...
    # ======================================================
    # Initialize Dataset, Collator and Dataloader
    # ======================================================
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_samples", type=int, default=100, help="Number of samples for benchmarking.")
    parser.add_argument(
