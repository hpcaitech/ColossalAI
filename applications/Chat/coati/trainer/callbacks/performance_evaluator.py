...
class ExperienceMakerPerformanceEvaluator(Callback):
...
class TrainerPerformaceEvaluator(Callback):

    def __init__(self, actor_num_params: int, critic_num_params: int, enable_grad_checkpoint: bool = False) -> None:
        super().__init__()
        self.world_size = get_world_size()
        self.actor_num_params = actor_num_params
        self.critic_num_params = critic_num_params
