...
from coati.dataset import DPOPretrainDataset, HhRlhfDataset, RmStaticDataset
from coati.models.bloom import BLOOMActor
from coati.models.gpt import GPTActor
from coati.models.llama import LlamaActor
from coati.models.opt import OPTActor
from coati.trainer import PretrainTrainer
...
def main(args):
    ...
    if args.dataset == "Dahoas/rm-static":
        train_dataset = DPOPretrainDataset(RmStaticDataset(train_data, tokenizer, args.max_len))
        eval_dataset = DPOPretrainDataset(RmStaticDataset(eval_data, tokenizer, args.max_len))
    elif args.dataset == "Anthropic/hh-rlhf":
        train_dataset = DPOPretrainDataset(HhRlhfDataset(train_data, tokenizer, args.max_len))
        eval_dataset = DPOPretrainDataset(HhRlhfDataset(eval_data, tokenizer, args.max_len))
    else:
    ...
    trainer = PretrainTrainer(
        strategy, actor, actor_optim, actor_lr_scheduler, tokenizer=tokenizer, max_epochs=args.max_epoch
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_datasets_size", type=int, default=100000)
    parser.add_argument(
        "--strategy",
