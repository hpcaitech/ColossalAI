...
from colossalqa.prompt.prompt import SUMMARY_PROMPT_ZH, PROMPT_DISAMBIGUATE_ZH, PROMPT_RETRIEVAL_QA_ZH
...
class ChineseRetrievalConversation:
    ...
    def __init__(self, retriever: CustomRetriever, model_path: str, model_name: str) -> None:
        ...
        self.memory.initiate_document_retrieval_chain(self.llm, 
                                    PROMPT_RETRIEVAL_QA_ZH, self.retriever, chain_type_kwargs={'chat_history':'', })
        self.retrieval_chain = RetrievalQA.from_chain_type(llm=self.llm, verbose=False, chain_type="stuff", 
                retriever=self.retriever, chain_type_kwargs={"prompt": PROMPT_RETRIEVAL_QA_ZH,"memory":self.memory },
    ...
    @classmethod
    def from_retriever(cls, retriever: CustomRetriever, model_path: str, model_name: str) -> "ChineseRetrievalConversation":
