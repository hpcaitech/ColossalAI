...
class Booster:
    ...
    #     assert (not isinstance(model, PeftModel)) and (not isinstance(model, ModelWrapper)), f"Lora should be loaded before boosting or enabling lora."
    #     self.checkpoint_io.load_lora_from_pretrained(model, checkpoint)
