...
class GPTJPipelineForwards:
    ...
    def gptj_model_forward(
        ...
        shard_config: ShardConfig = None) -> Union[Dict, Tuple, BaseModelOutputWithPast]: 
    ...
    def gptj_causallm_model_forward(
        ...
        hidden_states: Optional[torch.FloatTensor] = None,
        stage_index: Optional[List[int]] = None,
        shard_config: ShardConfig = None) -> Union[Dict, Tuple, CausalLMOutputWithPast]:
        r"""
        ...
        transformer_outputs = GPTJPipelineForwards.gptj_model_forward(self.transformer,
                                                                        input_ids,
    ...
    def gptj_for_question_answering_forward(
       ...
       return_dict: Optional[bool] = None,
        ...
        outputs = GPTJPipelineForwards.gptj_model_forward(self.transformer,
                                                            input_ids,
                                                            attention_mask=attention_mask,
                                                            token_type_ids=token_type_ids,
                                                            position_ids=position_ids,
