...
def get_gptj_flash_attention_forward():
    ...
    def split_heads(self, tensor, num_attention_heads, attn_head_size, rotary):
        """
    ...
    def forward(
        ...
        query = self.split_heads(query, self.num_attention_heads, self.head_dim, True)
        key = self.split_heads(key, self.num_attention_heads, self.head_dim, True)
        value = self.split_heads(value, self.num_attention_heads, self.head_dim, False)
