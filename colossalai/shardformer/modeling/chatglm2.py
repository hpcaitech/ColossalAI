    ...
    def forward(
        ...
        if sp_mode in ["split_gather"]:
            inputs_embeds = split_forward_gather_backward(
                inputs_embeds, dim=0, process_group=sp_group, fp8_communication=shard_config.fp8_communication
            )
    ...
    def forward(
        ...
        if sp_mode == "all_to_all":
            ...
            query_layer = all_to_all_comm(
                query_layer, sp_group, gather_dim=0, fp8_communication=shard_config.fp8_communication
            )
            key_layer = all_to_all_comm(
                key_layer, sp_group, gather_dim=0, fp8_communication=shard_config.fp8_communication
            )
            value_layer = all_to_all_comm(
                value_layer, sp_group, gather_dim=0, fp8_communication=shard_config.fp8_communication
            )
        ...
        if sp_mode == "all_to_all":
            context_layer = all_to_all_comm(
                context_layer, sp_group, gather_dim=2, scatter_dim=0, fp8_communication=shard_config.fp8_communication
            )
