...
from transformers.models.t5.modeling_t5 import T5EncoderModel, T5ForConditionalGeneration, T5Model, T5Stack, T5ForTokenClassification
...
class T5PipelineForwards:
    ...
    def t5_for_token_classification_forward(
        ...
        outputs = T5PipelineForwards.t5_encoder_model_forward(
            self.transformer,
            input_ids=input_ids,
            attention_mask=attention_mask,
            inputs_embeds=inputs_embeds,
        ...
        if stage_manager.is_last_stage():
            ...
            # return {
            #     "hidden_states": outputs["hidden_states"],
            #     # "position_bias": outputs["position_bias"],
            #     # "encoder_decoder_position_bias":outputs["encoder_decoder_position_bias"]
            # }
            return outputs
