...
class GPT2ModelPolicy(GPT2Policy):
    ...
    def module_policy(self):
        ...
        if self.pipeline_stage_manager:
            ...
            method_replacement = {
                'forward': partial(GPT2PipelineForwards.gpt2_model_forward, 
...
class GPT2PipelineForwards:
    ...
    def gpt2_model_forward(
            ...
            stage_input_states: Optional[torch.FloatTensor] = None,
            ...
            if stage_manager.is_first_stage():
                ...
                assert stage_input_states is not None
                input_shape = stage_input_states.size()[:-1]
                batch_size, seq_length = input_shape[0], input_shape[1]
                device = stage_input_states.device
            ...
            if stage_manager.is_first_stage():
                ...
                hidden_states = stage_input_states
