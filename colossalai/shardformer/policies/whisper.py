...
class WhisperPolicy(Policy):
    def __init__(self) -> None:
        ...
        transformers_version = version.Version(transformers.__version__)
        assert transformers_version <= version.Version("4.33.0"), "The Whisper model should run on a transformers version not greater than 4.33.0."
