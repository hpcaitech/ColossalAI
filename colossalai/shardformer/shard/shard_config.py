...
class ShardConfig:
    ...
    Args:
        ...
        pipeline_scheduler (Optional[PipelineSchedule]): If using interleaved pp, it's necessary to specify the scheduler for layer assignment for each device.
    ...
    pipeline_scheduler: Optional[PipelineSchedule] = None
