/*
 * Adapted from vllm team https://github.com/vllm-project/vllm
 */
#include <torch/extension.h>
#include <ATen/cuda/CUDAContext.h>

namespace colossal_inference {
  ...
  torch::Tensor& cos_sin_cache)     // [max_position, rot_dim]
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
    ...
    [&] {
      colossal_inference::rotary_embedding_neox_kernel<scalar_t><<<grid, block, 0, stream>>>(
