...
def colo_addmm_1Drow(input_tensor: ColoTensor, mat1: ColoTensor, mat2: ColoTensor, beta: Number,
    ...
    mat1 = mat1.convert_to_dist_spec(
        distspec.shard(mat2.tensor_spec.dist_spec.process_group, [-1], [mat2.tensor_spec.get_process_group_size()]))

    # Output:P
    partial_output = torch.mm(mat1, mat2)
    # Reduce(Output)
    output = reduce_input(partial_output, mat1.tensor_spec.dist_spec.process_group)
    # input
    ...
    output = ColoTensor.from_torch_tensor(output,
                                          spec=TensorSpec(distspec.replicate(mat2.tensor_spec.dist_spec.process_group)))
    return output
...
def colo_addmm_1Dcol(input_tensor: ColoTensor, mat1: ColoTensor, mat2: ColoTensor, beta: Number,
    ...
    mat1 = mat1.convert_to_dist_spec(distspec.replicate(mat2.tensor_spec.dist_spec.process_group))
    mat1 = reduce_grad(mat1, mat1.tensor_spec.dist_spec.process_group)
