    ...
    def step(self, closure=None):
        ...
        for group_id in range(self.num_param_groups):
            ...
            for idx, splited_param in enumerate(master_working_param):
                ...
                padding_right = working_param.numel() - (self._local_rank+1) * splited_param.numel()
                print(working_param.shape, padding_left, padding_right, self._local_rank, splited_param.numel())
                working_param.data.copy_(torch.nn.functional.pad(splited_param, (padding_left, padding_right)).reshape_as(working_param))
