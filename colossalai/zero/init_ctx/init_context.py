...
class ZeroInitContext(InsertPostInitMethodToModuleSubClasses):
    ...
    def _post_init_method(self, module):
        ...
        for param in module.parameters():
            ...
            if self.shard_param:
                self.shard_strategy.shard([param.col_attr._sharded_data_tensor], self.dp_process_group)
                GLOBAL_MODEL_DATA_TRACER.add_tensor(param.col_attr._sharded_data_tensor.payload)
