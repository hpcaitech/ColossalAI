...
class ZeroRedundancyOptimizer_Level_3(Optimizer):
    ...
    def __init__(self,
        ...
        self.deepspeed_adam_offload = (self.offload_optimizer and
                                       type(init_optimizer) == DeepSpeedCPUAdam)
        ...
        largest_partitioned_param_numel = max([
            max([tensor.numel()
                 for tensor in fp16_partitioned_group])
    ...
    def _create_fp16_partitions(self):
        ...
        for j, param_group in enumerate(self.optimizer.param_groups):
            ...
            for sub_group in sub_groups:
                ...
                for partitioned_param, q in zip(self.fp16_partitioned_groups[i],
                                                updated_params):
    ...
    def _create_fp16_partitions_with_defragmentation(self):
        ...
        for j, param_group in enumerate(self.optimizer.param_groups):
            ...
            for sub_group in sub_groups:
                ...
                # removing cloning here
                if self.verbose:
                    report_memory_usage(f"Before Flattening param subgroup {i}")
        ...
        if not self.offload_optimizer:
            for i, sub_group in enumerate(self.fp16_groups):
                self.averaged_gradients[i] = [
                    ...
                    param.grad.data.narrow(0, 0, param.ds_tensor.numel())
