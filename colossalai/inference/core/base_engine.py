...
from colossalai.inference.config import InferenceConfig, ModelShardInferenceConfig
...
class InferenceEngine:
    ...
    def __init__(
        ...
        if self.model_type == ModelType.LLM:
            from .llm_engine import LLMEngine  # avoid circular import
            ...
            from .diffusion_engine import DiffusionEngine  # avoid circular import
