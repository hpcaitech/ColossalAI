...
from colossalai.inference.struct import RequestStatus, Sequence, Sequence_
...
class NaiveRequestHandler:
    def __init__(self) -> None:
        self.running_list: List[Sequence_] = []
    ...
    def add_sequence(self, seq: Sequence_):
        """
    ...
    def _find_sequence(self, request_id: int) -> Sequence_:
        """
