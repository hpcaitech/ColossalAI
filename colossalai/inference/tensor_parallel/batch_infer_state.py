...
# adaped from: lightllm/server/router/model_infer/infer_batch.py
@dataclass
class BatchInferState:
    ...
    # adapeted from: https://github.com/ModelTC/lightllm/blob/28c1267cfca536b7b4f28e921e03de735b003039/lightllm/common/infer_utils.py#L1
    @staticmethod
    def init_block_loc(
