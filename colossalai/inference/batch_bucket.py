...
class BatchBucket:
    ...
    def __init__(
        ...
        self.generate_token_size = generate_token_size
        ...
        if enable_streamingllm:
            max_blocks_per_seq = (start_token_size + generate_token_size + block_size - 1) // block_size + 1
        else:
    ...
    def streamingllm_update_batch(self, start_token_size: int, generate_token_size: int):
        """
        ...
        if self.current_batch_size > 0:
            ...
            for batch_id in range(self.current_batch_size):
                ...
                if sequence_lengths_list[batch_id] == start_token_size + generate_token_size + self.block_size - 1:
                    need_update = True
                    sequence_lengths_list[batch_id] = start_token_size + generate_token_size
