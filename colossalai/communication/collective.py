...
def reduce_scatter(tensor: Tensor,
    ...
    :param parallel_mode: Parallel group mode used in this communication
    :param op: The type of reduce operation, should be included in [SUM, AVG, PRODUCT, MIN, MAX, BAND, BOR, BXOR]
    :param async_op: Whether operations are asynchronous
    :type tensor: :class:`torch.Tensor`
    :type dim: int
    :type parallel_mode: :class:`colossalai.context.ParallelMode`
    :type op: torch.distributed.ReduceOp, optional
    :type async_op: bool, optional
    :return: The tensor generated by reduce-scatter
    :rtype: :class:`Tensor`

    More details about ReduceOp please refer https://pytorch.org/docs/stable/distributed.html#torch.distributed.ReduceOp
    """
    depth = gpc.get_world_size(parallel_mode)
    if depth == 1:
        out = tensor
