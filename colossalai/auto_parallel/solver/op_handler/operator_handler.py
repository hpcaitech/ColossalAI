...
from colossalai.auto_parallel.solver.constants import CONV_FUNC_OP, LINEAR_FUNC_OP
...
class OperatorHandler(ABC):
    ...
    def __init__(self,
        ...
        elif self.node.op == 'call_function' and self.node.target in (CONV_FUNC_OP + LINEAR_FUNC_OP):
            module = None
