...
# command: 
# srun -u /home/users/u100036/project-home/wcr/gpt/run.sh /home/users/u100036/project-home/wcr/gpt/train_bert.py
...
export DATA=/project/scratch/p200012/dataset/openwebtext/small-gpt-dataset.json


if [ "$config_file" ]
then
    NCCL_ALGO=Ring NCCL_CROSS_NIC=1 NCCL_NET_GDR_LEVEL=5 python -u $python_file --host=$master --config=$config_file
else
    NCCL_ALGO=Ring NCCL_CROSS_NIC=1 NCCL_NET_GDR_LEVEL=5 python -u $python_file --host=$master
fi