...
def vit_tiny_3d_patch16_224(**kwargs):
    model_kwargs = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, hidden_dim=768, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_tiny_3d_patch16_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=16, embed_dim=192, depth=12, num_heads=3, hidden_dim=768, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_small_3d_patch16_224(**kwargs):
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, hidden_dim=1536, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_small_3d_patch16_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=16, embed_dim=384, depth=12, num_heads=6, hidden_dim=1536, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_small_3d_patch32_224(**kwargs):
    model_kwargs = dict(patch_size=32, embed_dim=384, depth=12, num_heads=6, hidden_dim=1536, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_small_3d_patch32_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=32, embed_dim=384, depth=12, num_heads=6, hidden_dim=1536, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_base_3d_patch16_224(**kwargs):
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, hidden_dim=3072, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_base_3d_patch16_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=16, embed_dim=768, depth=12, num_heads=12, hidden_dim=3072, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_base_3d_patch32_224(**kwargs):
    model_kwargs = dict(patch_size=32, embed_dim=768, depth=12, num_heads=12, hidden_dim=3072, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_base_3d_patch32_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=32, embed_dim=768, depth=12, num_heads=12, hidden_dim=3072, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_large_3d_patch16_224(**kwargs):
    model_kwargs = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16, hidden_dim=4096, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_large_3d_patch16_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=16, embed_dim=1024, depth=24, num_heads=16, hidden_dim=4096, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_large_3d_patch32_224(**kwargs):
    model_kwargs = dict(patch_size=32, embed_dim=1024, depth=24, num_heads=16, hidden_dim=4096, **kwargs)
    return _create_vit_model(**model_kwargs)


@MODELS.register_module
def vit_large_3d_patch32_384(**kwargs):
    model_kwargs = dict(img_size=384, patch_size=32, embed_dim=1024, depth=24, num_heads=16, hidden_dim=4096, **kwargs)
    return _create_vit_model(**model_kwargs)
