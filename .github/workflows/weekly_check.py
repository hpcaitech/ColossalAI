...
def main():
    ...
    for file_loc in contents:
        ...
        if len(split_loc) - split_loc.index('examples') >= 3:  # must have two sub-folder levels after examples folder, such as examples/images/vit is acceptable. examples/images/README.md is not, examples/requirements.txt is not.
