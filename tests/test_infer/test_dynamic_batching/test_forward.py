...
def run():
    arg = args(max_total_token_num=42, model="llama" ,batch_max_tokens=42, eos_id=0, disable_log_stats=False, log_stats_interval=10)
    ...
    # manager._set_tokenizer(tokenizer_name = model.__class__.__name__) done in start_dynamic_batching
