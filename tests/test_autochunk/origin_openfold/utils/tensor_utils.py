...
def _get_minimal_slice_set(
    ...
    def upper():
        ...
        return [
            ...
            for s in _get_minimal_slice_set(start[divergence_idx + 1:], [d - 1 for d in dims[divergence_idx + 1:]],
    ...
    def lower():
        ...
        return [
            path + (slice(edi, edi + 1),) + s for s in _get_minimal_slice_set(
...
def chunk_layer(
    ...
    for _ in range(no_chunks):
        ...
        if (not low_mem):
            ...
            select_chunk = (partial(_chunk_slice,
                                    flat_start=i,
