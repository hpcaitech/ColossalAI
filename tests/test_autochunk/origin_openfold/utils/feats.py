...
from fastfold.utils.tensor_utils import batched_gather, one_hot, tensor_tree_map, tree_map
...
def pseudo_beta_fn(aatype, all_atom_positions: torch.Tensor,
                   all_atom_masks: torch.Tensor) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
...
def build_template_pair_feat(batch: Dict[str, Any],
                             min_bin: float,
                             max_bin: float,
                             no_bins: int,
