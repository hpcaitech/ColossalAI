...
config = transformers.BloomConfig(n_layer=2, n_head=4, vocab_size=250880, hidden_dropout=0, hidden_size=64)
...
model_zoo.register(name='transformers_bloom_for_casual_lm',
