...
2. define the mixed precision configuration in the config file. For example, in order to use 1D tensor parallel, you can just write these lines of code below into your config file.
