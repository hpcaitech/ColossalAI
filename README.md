...
- [Cached Embedding](https://github.com/hpcaitech/FreqCacheEmbedding), utilize software cache to training larger embedding tables with smaller GPU memory budget.
